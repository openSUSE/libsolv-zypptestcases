install 3ddiag-0.729-5.x86_64@packages
install 855resolution-0.4-10.x86_64@packages
install CheckHardware-0.1-977.x86_64@packages
install Mesa-32bit-6.4.2-4.x86_64@packages
install Mesa-6.4.2-4.x86_64@packages
...
install alsa-1.0.11-12.x86_64@packages
install alsa-32bit-1.0.11-12.x86_64@packages
install ash-1.6.1-7.x86_64@packages
install at-3.1.8-912.x86_64@packages
install atk-1.10.3-6.x86_64@packages
install atk-32bit-1.10.3-6.x86_64@packages
install audiofile-0.2.6-9.x86_64@packages
install audiofile-32bit-0.2.6-9.x86_64@packages
install bash-3.1-10.x86_64@packages
install bc-1.06-755.x86_64@packages
install binutils-2.16.91.0.5-7.x86_64@packages
install bitstream-vera-1.10-172.noarch@packages
install blocxx-1.0.0-4.x86_64@packages
install boost-1.33.1-6.x86_64@packages
install bzip2-1.0.3-9.x86_64@packages
install cabextract-1.1-8.x86_64@packages
install cairo-1.0.2-14.x86_64@packages
install cairo-32bit-1.0.2-14.x86_64@packages
...
install dejavu-2.2-5.noarch@packages
install desktop-data-SuSE-10.1-15.noarch@packages
install device-mapper-1.02.02-6.x86_64@packages
install dialog-0.9b-196.x86_64@packages
install diffutils-2.8.7-8.x86_64@packages
install e2fsprogs-1.38-17.x86_64@packages
install ed-0.2-873.x86_64@packages
install esound-0.2.36-8.x86_64@packages
install esound-32bit-0.2.36-8.x86_64@packages
install evms-2.5.4-7.x86_64@packages
install evms-gui-2.5.4-7.x86_64@packages
...
install fontconfig-2.3.93.20060224-2.x86_64@packages
install fontconfig-32bit-2.3.93.20060224-2.x86_64@packages
install fonts-config-20060210-4.noarch@packages
install freeglut-051110-6.x86_64@packages
install freeglut-32bit-051110-6.x86_64@packages
install freetype-1.3.1-1164.x86_64@packages
install freetype-32bit-1.3.1-1164.x86_64@packages
install freetype2-2.1.10-8.x86_64@packages
install freetype2-32bit-2.1.10-8.x86_64@packages
install fribidi-0.10.4-490.x86_64@packages
install fribidi-32bit-0.10.4-490.x86_64@packages
install fvwm2-2.5.12-9.x86_64@packages
install gawk-3.1.5-8.x86_64@packages
install gdbm-1.8.3-235.x86_64@packages
install gettext-0.14.5-5.x86_64@packages
install ghostscript-fonts-other-8.15.2rc1-9.x86_64@packages
install ghostscript-fonts-std-8.15.2rc1-9.x86_64@packages
install ghostscript-library-8.15.2rc1-9.x86_64@packages
install ghostscript-x11-8.15.2rc1-9.x86_64@packages
install giflib-32bit-4.1.4-5.x86_64@packages
install giflib-4.1.4-5.x86_64@packages
install glib-1.2.10-601.x86_64@packages
install glib-32bit-1.2.10-601.x86_64@packages
...
install glitz-0.4.4-12.x86_64@packages
install glitz-32bit-0.4.4-12.x86_64@packages
...
install gtk-1.2.10-898.x86_64@packages
install gtk-32bit-1.2.10-898.x86_64@packages
install gtk2-2.8.10-15.x86_64@packages
install gtk2-32bit-2.8.10-15.x86_64@packages
install gzip-1.3.5-149.x86_64@packages
install hal-0.5.6-12.x86_64@packages
install hplip-hpijs-0.9.7-7.x86_64@packages
install hwinfo-12.9-2.x86_64@packages
install ifnteuro-1.2.1-199.noarch@packages
install imlib-1.9.14-204.x86_64@packages
install imlib-32bit-1.9.14-204.x86_64@packages
install info-4.8-14.x86_64@packages
install insserv-1.04.0-10.x86_64@packages
install intlfnts-1.2.1-199.noarch@packages
...
install libdrm-2.0-7.x86_64@packages
install libdrm-32bit-2.0-7.x86_64@packages
install libgcc-4.1.0_20060223-3.x86_64@packages
install libgimpprint-4.2.7-51.x86_64@packages
...
install libnetpbm-1.0.0-648.x86_64@packages
install libnetpbm-32bit-1.0.0-648.x86_64@packages
...
install libstroke-0.5.1-6.x86_64@packages
...
install lsb-3.0-10.x86_64@packages
...
install net-snmp-5.3.0.1-7.x86_64@packages
...
install pango-1.10.2-11.x86_64@packages
install pango-32bit-1.10.2-11.x86_64@packages
...
install perl-TermReadKey-2.30-5.x86_64@packages
install perl-XML-Parser-2.34-35.x86_64@packages
...
install qt3-3.3.5-34.x86_64@packages
install qt3-32bit-3.3.5-34.x86_64@packages
...
install sax2-7.1-87.x86_64@packages
install sax2-gui-1.7-87.x86_64@packages
install sax2-ident-1.7-87.x86_64@packages
install sax2-libsax-7.1-87.x86_64@packages
install sax2-libsax-perl-7.1-87.x86_64@packages
install sax2-tools-2.7-87.x86_64@packages
...
install tcl-32bit-8.4.12-8.x86_64@packages
install tcl-8.4.12-8.x86_64@packages
install tcpd-7.6-722.x86_64@packages
install tightvnc-1.2.9-189.x86_64@packages
install tk-32bit-8.4.12-5.x86_64@packages
install tk-8.4.12-5.x86_64@packages
install unclutter-8-841.x86_64@packages
...
install x11-input-synaptics-0.14.4-6.x86_64@packages
install x11-tools-0.1-27.x86_64@packages
install xaw3d-1.5E-230.x86_64@packages
install xaw3d-32bit-1.5E-230.x86_64@packages
install xbanner-1.31-864.x86_64@packages
install xdg-menu-0.2-57.x86_64@packages
install xdmbgrd-0.5-35.x86_64@packages
install xkeyboard-config-0.7-8.noarch@packages
install xli-20050904-7.x86_64@packages
install xlockmore-5.21-4.x86_64@packages
install xorg-x11-6.9.0-20.x86_64@packages
install xorg-x11-Xvnc-6.9.0-20.x86_64@packages
install xorg-x11-driver-video-6.9.0-22.x86_64@packages
install xorg-x11-driver-video-nvidia-6.9.0-22.x86_64@packages
install xorg-x11-fonts-75dpi-6.9.0-20.x86_64@packages
install xorg-x11-fonts-scalable-6.9.0-20.x86_64@packages
install xorg-x11-libs-32bit-6.9.0-20.x86_64@packages
install xorg-x11-libs-6.9.0-20.x86_64@packages
install xorg-x11-man-6.9.0-20.x86_64@packages
install xorg-x11-server-6.9.0-20.x86_64@packages
install xorg-x11-server-glx-6.9.0-20.x86_64@packages
install xterm-208-5.x86_64@packages
install xtermset-0.5.2-126.x86_64@packages
install yast2-2.13.33-2.x86_64@packages
install yast2-control-center-2.13.2-4.x86_64@packages
...
install yast2-qt-2.13.22-3.x86_64@packages
install yast2-theme-SuSELinux-2.13.3-5.noarch@packages
install yast2-x11-2.13.6-23.noarch@packages
