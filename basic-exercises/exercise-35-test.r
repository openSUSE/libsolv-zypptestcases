...
problem 2295fc38 info nothing provides libgnomeprint15 = 0.34 needed by gnome-print-devel-1:0.34-ximian.1.noarch
problem 2295fc38 solution 65b433cd erase gnome-print-devel-1:0.34-ximian.1.noarch@system
...
problem 4cbce254 info nothing provides esound = 0.2.23.0.200202140152 needed by esound-devel-1:0.2.23.0.200202140152-snap.ximian.1.noarch
problem 4cbce254 solution 8abccc30 erase libgnomeui-devel-1.111.1.0.200202140152-snap.ximian.1.noarch@system
...
problem 73739be3 info nothing provides esound = 0.2.23.0.200202140152 needed by esound-devel-1:0.2.23.0.200202140152-snap.ximian.1.noarch
problem 73739be3 solution c1a0ead0 erase libbonoboui-devel-1.111.0.0.200202140152-snap.ximian.1.noarch@system
...
problem 84492a53 info nothing provides esound = 0.2.23.0.200202140152 needed by esound-devel-1:0.2.23.0.200202140152-snap.ximian.1.noarch
problem 84492a53 solution 110978e6 erase libgnome-devel-1.111.0.0.200202140152-snap.ximian.2.noarch@system
...
problem e44ca2fd info nothing provides libgnomeprint15 = 0.34 needed by gnome-print-devel-1:0.34-ximian.1.noarch
problem e44ca2fd solution f7491736 erase gtkhtml-devel-1.0.1.99-snap.ximian.200201141703.noarch@system
...
problem e6f4486c info nothing provides pygtk = 0.6.8 needed by pygtk-libglade-1:0.6.8-3.noarch
problem e6f4486c solution 09da32f9 erase printconf-gui-0.3.52-1.noarch@system
